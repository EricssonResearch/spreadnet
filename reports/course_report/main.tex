...
%\addbibresources{reports}        % Selects the Bibliography file.
...
% \addbibresource{reports/bibliography/sources.bib}
%\bibliography{}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{reports/course_report/text/introduction.tex}{Introduction}
%\input{introduction}
%\subfile{text/introduction}
